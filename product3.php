...
8-921-063-17-15
    ...
    <div class="product">
      <div class="tov">
        <img src="img/product3.jpg" width="200px" style="margin-left:-200px">
      </div>
        <div class="name" style="margin-top:-250px"><h3>Системы ультрафильтрации
        питьевой воды<br></h3>
        </div>
        <div class="text9" >Описание и предназначение данного товара:</div>
        <div class="ul">
            <li>Рабочий диапазон давления воды - (0.04 … 0.8) МПа.</li>
            <li>Максимальная температура воды - не более 40°С.</li>
            <li>Максимальная производительность (700 … 1000) л/сутки.</li>
            <li>В комплект поставки входят элементы подключения к водопроводу,
                <br> кран чистой воды и ключ для колб.</li>
            <li>Материал колб и постфильтра - полипропилен.</li>
            
            
        </div>
        <div class="block4" style="margin-top:50px">
          <h4 style="margin-left:50px">  от 3900 руб.</h4>
        </div>
        <div class="block2">
    ...
    <div class="products">
        ...
        <div class="p">
            ...
            <img src="img/t14.png" height="150px">
            <h4><a href="*">Электромагнитный клапан<br>
            воздушный MIVALT – MP160
            <br>
             </a></h4>
