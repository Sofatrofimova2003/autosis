...
8-921-063-17-15
    ...
    <div class="product">
      <div class="tov">
        <img src="img/product2.jpg" width="200px" style="margin-left:-200px">
      </div>
        <div class="name" style="margin-top:-250px"><h3>САВ "AquaTechnica"
        (самовсасывающая )<br></h3>
        </div>
        <div class="text9" >Описание и предназначение данного товара:</div>
        <div class="ul">
            <li>Произведены компанией ООО "ПТФ Акватехника", Россия.</li>
            <li>Максимальная высота всасывания - не более 7,5 м.</li>
            <li>Объем гидроаккумулятора - 24 л.</li>
            <li>Максимальная температура воды - не более 40°С.</li>
            <li>Класс защиты - IP Х4.</li>
            <li>Содержание механических примесей;- не более 100 г/м3.</li>
            <li>Материалы: корпус насоса - чугун; рабочее колесо – технополимер (РРО); <br>торцевое уплотнение вала - керамика и графит; мембрана гидроаккумулятора - EPDM резина.</li>
        ...
        <div class="p">
            ...
            <div class="p1">
              ...
              <div class="p2">
                ...
                <img src="img/t6.png" height="130px">
                ...
                <div class="p3">
                  ...
                  <h4><a href="*">Системы ультрафильтрации<br>
                  питьевой воды</a></h4>
                    <button class="button12"><a>Посмотреть</a></button>
                  </div>
